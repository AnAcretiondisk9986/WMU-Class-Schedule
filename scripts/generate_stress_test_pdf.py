...
PAGE_TWO = [
    ...
    event(2, "医学遗传学", "讲课", "9", "1-16周", "滨海校区", "10-B203", "孙鹏", "NN260018-120018-1", 2.5, note="与茶山第8节保留5分钟间隔"),
...
def draw_notes_page(c):
    ...
    data = [
        ...
        ["零冲突导入", "周二茶山第8节13:30-14:10，滨海第9节14:15-14:55", "应报告0组跨校区时间冲突"],
...
def build_pdf():
    ...
    draw_schedule_page(c, PAGE_TWO, 2, "边界与零冲突")
    draw_notes_page(c)
    c.save()
    print(OUTPUT)
